...
export const Facebook: React.FC<IconsProps> = ({ onClick, customClass }) => {
  return (
    ...
    >
      <path
        d="M23.75 36.7051H13.25C4.5 36.7051 1 33.2051 1 24.4551V13.9551C1 5.20508 4.5 1.70508 13.25 1.70508H23.75C32.5 1.70508 36 5.20508 36 13.9551V24.4551C36 33.2051 32.5 36.7051 23.75 36.7051Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      ...
      />
      <path
        d="M22 14.4806V19.5556H26.55C26.9 19.5556 27.075 19.9056 27.075 20.2556L26.375 23.5806C26.375 23.7556 26.025 23.9306 25.85 23.9306H22V36.7056H16.75V24.1056H13.775C13.425 24.1056 13.25 23.9306 13.25 23.5806V20.2556C13.25 19.9056 13.425 19.7306 13.775 19.7306H16.75V13.9556C16.75 10.9806 19.025 8.70557 22 8.70557H26.725C27.075 8.70557 27.25 8.88057 27.25 9.23057V13.4306C27.25 13.7806 27.075 13.9556 26.725 13.9556H22.525C22.175 13.9556 22 14.1306 22 14.4806Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
        strokeLinecap="round"
